...
import br.edu.infnet.appdent.model.service.EnderecoService;
...
public class EnderecoController {
	...
	@PostMapping(value = "/cepPaciente")
	public String buscaCepPaciente(Model model, @RequestParam String cep) {
